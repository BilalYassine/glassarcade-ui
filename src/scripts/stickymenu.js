  ...
  window.onscroll = function () {
    ...
    if(logo.length) {
      ...
      if (ud_header.classList.contains('sticky-header')) {
        document.querySelector(".header-logo").src = '/assets/logo/Glass-Arcade-Logo-Blue.png';
      } else {
        document.querySelector('.header-logo').src = '/assets/logo/Glass-Arcade-Logo-Red.png';
      }
    }
